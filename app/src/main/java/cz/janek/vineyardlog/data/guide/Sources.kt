...
object Sources {
    val VARIETIES = SourceTopic(
        ...
        Bi("Ripening class, harvest window and susceptibility are typical values for South Moravia compiled from these references and growers' experience – orientation, not rules. The sugar range comes from the variety's Czech Wikipedia article and is missing where that article gives no figure; there is no official per-variety dataset, because grapevine is exempt from the ÚKZÚS utility-value trials and measured sugar swings by several °NM between sites and years. The only hard numbers on the scale are the categories of the wine law; what you pick at is your decision, set per block or in Settings.",
            "Ranost, okno sklizně a náchylnost jsou typické hodnoty pro jižní Moravu sestavené z těchto zdrojů a ze zkušenosti vinařů – orientace, ne pravidla. Rozsah cukernatosti je z hesla odrůdy na české Wikipedii a u odrůd, kde heslo číslo neuvádí, chybí; oficiální data po odrůdách neexistují, protože réva je vyňatá ze zkoušek užitné hodnoty ÚKZÚZ a naměřená cukernatost kolísá o několik °NM mezi tratěmi a ročníky. Jediná pevná čísla na stupnici jsou kategorie z vinařského zákona; při jaké cukernatosti sklízíš, je tvoje rozhodnutí – nastav ji u tratě nebo v Nastavení."),
        listOf(
            ...
            Source("Česká Wikipedie – hesla odrůd", "https://cs.wikipedia.org/wiki/Kategorie:Odr%C5%AFdy_r%C3%A9vy_vinn%C3%A9", Bi("The typical must sugar range (\"typically 17–20 °NM\") is taken from the variety's article, which draws on Czech ampelographic literature; varieties whose article gives no figure show none.", "Rozsah typické cukernatosti (\"typicky 17–20 °NM\") je převzatý z hesla odrůdy, které vychází z české ampelografické literatury; u odrůd, kde heslo číslo neuvádí, se nic neukazuje.")),
    ...
    val NUTRITION = SourceTopic(
        ...
        listOf(
            Source("AWRI viti-note: Nitrogen fertilisation", "https://www.awri.com.au/wp-content/uploads/1_nutrition_nitrogen_fertilisation.pdf", Bi("Mature vineyards: 50–60 kg N/ha in warm regions, about 20 kg N/ha in cooler ones, where rain and cover-crop turnover often cover the need without fertiliser.", "Plodné vinice: 50–60 kg N/ha v teplých oblastech, asi 20 kg N/ha v chladnějších, kde potřebu často pokryjí srážky a rozklad ozelenění i bez hnojiva.")),
