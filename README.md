...
- **More automatic reminders** – plan tasks at the start of their window, high disease risk after a background weather fetch (WorkManager), stuck fermentation and the next sampling date from the harvest estimate.
